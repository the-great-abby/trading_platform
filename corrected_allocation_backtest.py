#!/usr/bin/env python3
"""
Multi-Strategy Ensemble Backtest with Corrected Capital Allocation
================================================================
...
async def main():
    ...
    ensemble_strategy = MultiStrategyEnsemble(
        ...
        asset_allocation={
            ...
            'options_day_trading_pct': 0.10,  # 10% of options = 5% total
            'options_swing_trading_pct': 0.90, # 90% of options = 45% total
    ...
    engine.stock_allocation_pct = 0.30  # 30% stocks
    engine.options_allocation_pct = 0.50  # 50% options
    engine.options_day_trading_pct = 0.05  # 5% total for day trading
    engine.options_swing_trading_pct = 0.45  # 45% total for swing trading
    ...
    # Register the ensemble strategy
    strategy_registry = StrategyRegistry()
    strategy_registry.register_strategy(ensemble_strategy)
    engine.strategy_registry = strategy_registry
