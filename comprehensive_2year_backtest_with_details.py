#!/usr/bin/env python3
"""
Comprehensive 2-Year Backtest with Detailed Trade Analysis
========================================================
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('comprehensive_backtest_detailed.log'),
...
async def run_comprehensive_backtest():
    ...
    logger.info("🚀 STARTING COMPREHENSIVE 2-YEAR BACKTEST WITH DETAILED ANALYSIS")
    logger.info("=" * 80)
    ...
    # Strategy configuration with detailed parameters
    strategies_config = {
    ...
    try:
        ...
        filename = f"comprehensive_backtest_detailed_{timestamp}.json"
