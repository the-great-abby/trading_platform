...
for file in $FILES_TO_UPDATE; do
    ...
    sed -i.bak 's/docker build -t localhost:32000/docker build -t localhost:32000/g' "$file"
    sed -i.bak 's/docker push localhost:32000/docker push localhost:32000/g' "$file"
    sed -i.bak 's/REGISTRY_URL := localhost:32000/REGISTRY_URL := localhost:32000/g' "$file"
