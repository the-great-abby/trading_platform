#!/usr/bin/env python3
"""
Test Dynamic Position Sizing with Working Strategies
"""
...
async def test_dynamic_position_sizing_with_working_strategies():
    """Test dynamic position sizing with strategies we know work"""
    
    logger.info("🚀 TESTING DYNAMIC POSITION SIZING WITH WORKING STRATEGIES")
    logger.info("=" * 80)
    
    # Test configuration with working strategies
    test_config = {
        "symbols": ["AAPL", "MSFT", "GOOGL"],
        "start_date": "2023-10-01",
        "end_date": "2024-10-01",  # Shorter period for faster testing
    ...
    logger.info("\n🎯 RUNNING BACKTEST WITH DYNAMIC POSITION SIZING...")
    logger.info("-" * 50)
        ...
        if response.status_code == 200:
            ...
            if result.get("success"):
                ...
                if total_trades > 0:
                    ...
                    logger.info("✅ Kelly Criterion applied to position sizing")
                    logger.info("✅ Volatility-adjusted sizing implemented")
                    logger.info("✅ Confidence-based scaling active")
                    ...
                    logger.warning("⚠️ No trades generated - strategies may be too restrictive")
    ...
    logger.info("\n🏴‍☠️ DYNAMIC POSITION SIZING TEST COMPLETE!")

if __name__ == "__main__":
    asyncio.run(test_dynamic_position_sizing_with_working_strategies())
