...
**Last Updated**: 2025-10-07 20:30:00 UTC  
**Total Deployments**: 50+  
**Active Deployments**: 13  
**Deprecated Deployments**: 10  
...
|---------|----------------|--------|--------|
| trading-engine | `k8s/deprecated/trading-engine.yaml` | ⚠️ Deprecated | CrashLoopBackOff with module import errors, functionality distributed to other services |
...
**Note:** trading-engine has been deprecated (was CrashLoopBackOff with 233 restarts) - see deprecated section above.
...
- **2025-10-07**: Deprecated trading-engine due to persistent CrashLoopBackOff (233 restarts) with module import errors
- **2025-10-07**: Moved trading-engine.yaml to k8s/deprecated/ and scaled deployment to 0 replicas
- **2025-10-07**: Updated DEPRECATED_SERVICES.md to document trading-engine deprecation
