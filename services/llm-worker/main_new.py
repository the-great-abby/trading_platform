...
class LLMWorker:
    ...
    async def _consume_sentiment_tasks(self):
        ...
        await self.rabbitmq.consume_queue('llm.sentiment', callback)
    ...
    async def _consume_signal_tasks(self):
        ...
        await self.rabbitmq.consume_queue('llm.signal', callback)
    ...
    async def _consume_risk_tasks(self):
        ...
        await self.rabbitmq.consume_queue('llm.risk', callback)
    ...
    async def _consume_market_tasks(self):
        ...
        await self.rabbitmq.consume_queue('llm.market', callback)
    ...
    async def _consume_custom_tasks(self):
        ...
        await self.rabbitmq.consume_queue('llm.custom', callback)
