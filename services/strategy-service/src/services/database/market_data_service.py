...
class MarketDataDatabaseService:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info("Market data database initialized successfully with connection pooling")
    ...
    def _ensure_indexes(self):
        """Ensure all required indexes exist for market data tables"""
        try:
            import asyncio
            ...
            logger.info("✅ Market data indexes ensured")
