...
class TradingEngine:
    ...
    def should_buy(self, symbol: str, price: float) -> bool:
        ...
        import random
        # Simulate 5% chance of buy signal (reduced frequency)
        return random.random() < 0.05 and symbol not in self.state.active_positions
...
async def start_trading_engine():
    ...
    config = {
        ...
        'trading_interval': 30,  # 30 seconds for testing
